function isPrime(number) {
  ...
  thus it is not necessary to repeat the calculation past the product's square root: http://mathandmultimedia.com/2012/06/02/determining-primes-through-square-root/ */
